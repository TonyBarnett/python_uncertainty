import unittest
from uncertainty.data_sources.sql import _build_clas_value_query, _build_source_query
...
class BuildSourceSql(unittest.TestCase):
    def test_type(self):
        result = _build_source_query("SELECT * FROM NOTHING")
